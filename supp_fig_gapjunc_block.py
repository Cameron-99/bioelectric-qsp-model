...
# === AMILORIDE LEFT HALF (like your Fig 3) ===
...
# === PLOT & SAVE (PUBLICATION VERSION - NO "Reviewer 1") ===
...
# PUBLICATION CAPTION (no reviewer mention)
plt.suptitle('Supplementary Figure S4: Gap Junction Dependence of Tissue Vmem Patterning', 
